...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    SmartDashboard.putNumber("FlyWheel/speed", m_flywheel.getEncoder().getVelocity());
    SmartDashboard.putNumber("Trigger/speed", m_triggerMotor.getEncoder().getVelocity());
